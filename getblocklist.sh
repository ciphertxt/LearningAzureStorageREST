...
echo "usage: ${0##*/} <RESOURCE_GROUP_NAME> <STORAGE_ACCOUNT_NAME> <CONTAINER_AND_PATH>"

# https://docs.microsoft.com/rest/api/storageservices/get-block-list

RESOURCE_GROUP_NAME=$1
STORAGE_ACCOUNT_NAME=$2
CONTAINER_AND_PATH=$3
...
curl -sb -X GET \
    ...
    "https://${STORAGE_ACCOUNT_NAME}.blob.core.windows.net/${CONTAINER_AND_PATH}?comp=blocklist" | xmllint --format -